注意：本项目代码由DeeepSeek编写，可能含有各种注释以及无用代码片段，不影响最终功能。

本项目基于GeckoView 141.0.20250714153642和NanoHTTPD 2.3.1，旨在让安卓端运行完全本地化的网页。由于GeckoView不支持禁用CORS，故只能牺牲加载速度使用本地服务器。
